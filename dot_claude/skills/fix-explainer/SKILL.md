...
1. Create an external session directory and snapshot repository state:
   ...
   ```bash
   SKILL_DIR="${CLAUDE_CONFIG_DIR:-$HOME/.claude}/skills/fix-explainer"
