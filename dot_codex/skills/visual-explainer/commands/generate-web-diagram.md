...
Use the skill’s reference routing, narrative-first hybrid default, and final checklist. Pick a representation per section: narrow prose for explanation; Mermaid for connected flows/topologies; a card grid for comparable peers; labeled entries for matrix-style material; timelines for linear history.
