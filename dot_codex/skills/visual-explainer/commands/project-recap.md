...
Keep file maps and commands as compact labeled entries in a collapsible reference region, not tables. Follow the skill’s reading layout, Mermaid, overflow, and delivery rules.
